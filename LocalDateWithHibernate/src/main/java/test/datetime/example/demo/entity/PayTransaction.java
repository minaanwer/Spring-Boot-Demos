...
public class PayTransaction implements Serializable {
    ...
    @Column(name = "\"PayerBanKId\"")   // hangebo mn table members
    private int payerBanKId;
    @Column(name = "\"PayeeBanKId\"")    // hangebo mn table members
    private int payeeBanKId;
    @Column(name = "\"PayerPSPBankId\"")  // hangebo mn table members
    private int payerPSPBankId;
    @Column(name = "\"PayeePSPBankId\"")  // hangebo mn table members
    private int payeePSPBankId;
    @Column(name = "\"PayerPSPId\"")  // hangebo mn table members
    private int payerPSPId;
    @Column(name = "\"PayeePSPId\"")  // hangebo mn table members
    private int payeePSPId;
